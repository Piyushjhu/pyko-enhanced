...
# import hvplot.pandas  # Removed due to compatibility issues
...
del __version__
# from hvplot import __version__  # Removed due to compatibility issues
# print('hvplot version: ', __version__)  # Removed due to compatibility issues
# del __version__  # Removed due to compatibility issues
